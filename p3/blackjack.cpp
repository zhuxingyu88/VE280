...
// EFFECTS: return the type of the player
Player* judge_player(string& player_type);
...
// MODIFIES: deck player
void shuffle_deck(Deck& deck, Player* player);
...
int main(int argc, char* argv[]) {
    ...
    player_type = argv[3];
    // player type
    player = judge_player(player_type);
