...
// Type: Server_t
// ------------------
// The type Comment_t is used to represent a server
// It consists of:
// * all_users: An array of users
// * num_users: the number of posts
// * user_dic: the dictionary of user data
*/
{
    ...
    string user_dic;
    Tag_t all_tags[MAX_TAGS*MAX_POSTS*MAX_USERS];
};
